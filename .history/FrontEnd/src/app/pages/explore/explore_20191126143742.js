...
class Explore extends React.Component {
    ...
    getHashtagTweets = (event) => {
        console.log("in here");
        this.setState( {tweets :  ["dd24168d74c0c6c7f655a40"] })
    }
            ...
            <div>
                <div className="t-top-nav-explore" >
                    <div class="t-focus input-group">
                        ...
                        <input className="t-textbox form-control" onMouseEnter={this.getHashtagTweets} onChange={this.handleChange} type="text" id="hashtag"
